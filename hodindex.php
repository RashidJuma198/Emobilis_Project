...
<body>
    ...
    <nav>
        <button style="margin-left: 850px;height: 40px;width: 100px;border-radius: 20px;"><a href="adminindex.php">ADMIN</a></button>
    ...
    <form name="f1" action="submithodindex.php" onsubmit = "return validation()" method="POST">
        ...
        <label  for="department" ><b>Department</b></label><br>
            <select name="department" id="department" required  class="depart">
                ...
                <option value="Business Studies">Business Department</option>
                <option value="Liberal Studies">Liberal Department</option>  
            </select><br><br>
