...
<body style="background-color:rgb(148, 243, 4)">
    ...
    <div class="Title">
         <p>KISIWA TECHNIAL TRAINING INSTITUTE<br>PRINCIPAL OFFICE</p>
    </div><BR>
    <div class="studentname" >
        <form action="updateprincipal.php?ID=<?php echo $userid?>" method="POST" enctype="multipart/form-data">
        <fieldset>
    ...
    <fieldset class="hod">     
       ...
       <!--<select name="approved" id="approved" class="approved" readonly  value="<?php echo $approved?>" disable="disable">
 ...
 <fieldset class="principal">     
        ...
        <input type="text" name="comments" id="comments" required  value="<?php echo $commentss?>" >
        <label for="si">Signature:</label>
        <input type="text" name="si" id="si" required  value="<?php echo $signature?>">
        <label for="timeaccepted">Date Checked:</label>
        <input type="date" name="timeaccepted" id="timeaccepted" required  value="<?php echo $dateview?>" >
