...
KISIWA TECHNICAL TRAINING INSTITUTE<br>Knowledge And Skills For Better Life<br>P.O BOX 657-50200,BUNGOMA(KENYA)
Cell Phone:0712-225422/0736-559665/0714-980289<br>Email:kisiwainstitute@yahoo.com,<br>Website:<i>www.kisiwatti.ac.ke</i></b></p>
    ...
    <div class="studentname" >
        ...
        <fieldset>
            ...
            <input type="text" id="fname"  name="fname"   class="ffname" value="<?php echo $firstname?>">
            <label for="Mname" class="Mname" >Middle Name:</label>
            <input type="text" id="Mname"  name="mname"    class="mmname" value="<?php echo $middlename?>">
            <label for="Lname" class="Lname" >Last Name:</label>
            <input type="text" id="Lname"  name="lname"   class="llname" value="<?php echo $lastname?>"><br><br>
 
            <label for="ADM" class="ADM" >ADM No:</label>
            <input type="text" id="ADM"  name="ADM"   class="ADM" value="<?php echo $admno?>" ><br><br>
            <label for="series" class="series" >Exam Series:</label>
            <input type="date" id="series"  name="series"  class="series" value="<?php echo $examseries?>">
         ...
         <fieldset>
           ...
           <label for="depart">Department:</label>
            ...
            <input type="text" name="diploma"  value="<?php echo $diploma?>">
    ...
    <fieldset class="hod">     
        ...
        <input type="text" name="mmodule" id="mmodule"    value="<?php echo $hodmodule?>">
        <label for="percentage">Percentage Class Attendance:</label>
        <input type="number" name="percentage" id="percentage"   value="<?php echo $classattendance?>"><br><br>
        <label for="examfee">Examination Fee:</label>
        <input type="number" name="examfee" id="examfee"  value="<?php echo $examfee?>">
       ...
       <!-- <select name="approved" id="approved" class="approved" readonly  value="<?php echo $approved?>">
        ...
        <input type="text" name="reason"  id="reason"    value="<?php echo $reason?>"><br><br>
        <label for="hodname">H.O.D Name:</label>
        <input type="text" name="hodname" id="hodname"    value="<?php echo $hodname?>">
        <label for="period">Date Checked:</label>
        <input type="date" name="date" id="date"    value="<?php echo $periodchecked?>">

   </fieldset><br><br>
  <fieldset class="hod">     
    <legend><b>ACCOUNT'S DEPARTMENT</b></legend>
    <label for="feebalance">Fee Balance:</label>
    <input type="number" name="feebalance" id="feebalance"   value="<?php echo $feebalance?>">
    <label for="examfeepaid">Exam Fee Paid:</label>
    <input type="number" name="examfeepaid" id="examfeepaid"  value="<?php echo $examfeepaid?>">
    <label for="examfeenotpaid">Exam Fee Not Paid:</label>
    <input type="number" name="examfeenotpaid" id="examfeenotpaid"  value="<?php echo $examfeenotpaid?>"><br><br>
    <label for="accountantname">Accountant Name:</label>
    <input type="text" name="accountantname" id="accountantname"  value="<?php echo $accountantname?>">
    <label for="accountsperiod">Date Checked:</label>
    <input type="date" name="accountsperiod" id="accountsperiod"   value="<?php echo $checkedbyaccountant?>">
 ...
 <fieldset class="principal">     
        ...
        <input type="text" name="comments" id="comments"   value="<?php echo $commentss?>" >
        <label for="si">Signature:</label>
        <input type="text" name="si" id="si" value="<?php echo $signature?>">
        <label for="timeaccepted">Date Checked:</label>
        <input type="date" name="timeaccepted" id="timeaccepted"    value="<?php echo $dateview?>" >
        ...
        <fieldset class="principal">     
            ...
            <input type="text" name="IndexNumber" id="IndexNumber"    value="<?php echo $index?>" >
        ...
        <input type="text" name="latestKnecslip" id="latesKnecslip"  value="<?php echo $knecslip?>" >
        <label for="birthcertno">Birth Certificate NO:</label>
        <input type="text" name="birthcertno" id="birthcertno"  value="<?php echo $birthcertificate?>" > 
    </fieldset><br><br>
