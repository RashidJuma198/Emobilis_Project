...
$query ="SELECT *FROM tablestudent where Department ='Liberal Studies' AND Diploma ='MOD_II'
 AND Module ='CERTIFICATE';";
...
<div class="Title">
<p>LIBERAL DEPARTMENT<br>STUDENT INFO</p>
    </div>
    <br><br>
   
    <nav  >
      <button><a href="student.html">NEW STUDENT</a> </button> 
      <button><a href="liberalstudents.php">LIBERAL STUDENT'S </a> </button> 
      <button><a href="mod1liberalcert.php">CERTIFICATE MOD I </a></button> 
      <button><a href="mod2liberalcert.php">CERTIFICATE MOD II</a> </button> 
      <button><a href="mod1liberaldiploma.php">DIPLOMA MOD I </a></button> 
      <button><a href="mod2liberaldiploma.php">DIPLOMA MOD II </a></button>
      <button><a href="mod3liberaldiploma.php">DIPLOMA MOD III</a> </button>
                    ...
                    <table>
                        ...
                        ?>
                           <tr>
                                        ...
                                        <td><a href="libedit.php?GetID=<?php echo $userid?>">Edit</td>
