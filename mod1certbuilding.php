...
$query ="SELECT *FROM tablestudent where Department ='Building And Civil Engineering' 
...
<div class="Title">
         <p>Building And Civil Engineering<br>STUDENT INFO</p>
    </div>
    <br><br>
   
    <nav  >
      <button><a href="student.html">NEW STUDENT</a> </button> 
      <button><a href="buildingstudents.php">BUILDING STUDENT'S </a> </button>
      <button><a href="artisanbuilding.php">ARTISAN </a></button>  
      <button><a href="mod1certbuilding.php">CERTIFICATE MOD I </a></button> 
      <button><a href="mod2certbuilding.php">CERTIFICATE MOD II</a> </button> 
      <button><a href="mod1diplomabuilding.php">DIPLOMA MOD I </a></button> 
      <button><a href="mod2diplomabuilding.php">DIPLOMA MOD II </a></button>
      <button><a href="mod3diplomabuilding.php">DIPLOMA MOD III</a> </button>
                    ...
                    <table >
                        ...
                        ?>
                           <tr>
                                        ...
                                        <td><button><a href="buildedit.php?GetID=<?php echo $userid?>">Edit</button></td>
