...
<body style="background-color:rgb(148, 243, 4)">
    ...
    <div class="studentname" >
        <form action="ictupdate.php?ID=<?php echo $userid?>" method="POST" enctype="multipart/form-data">
        <fieldset>
      ...
      <fieldset>
            ...
            <input type="text" readonly value="<?php echo $module?>" >
           <!--<select name="module" id="module"  value="<?php echo $module?>" >
            ...
            <input type="text" readonly  value="<?php echo $diploma?>">
    ...
    <fieldset class="credentials">
        <legend>Examination Credentials</legend>
    ...
    <fieldset class="hod">     
        ...
        <input type="text" name="Class" id="Class" required value="<?php echo $class?>" >
       <!-- <label for="mmodule">Module:</label>
        <input type="text" name="mmodule" id="mmodule"  required value="<?php echo $hodmodule?>">-->
        <label for="percentage">Percentage Class Attendance:</label>
        <input type="number" name="percentage" id="percentage" required value="<?php echo $classattendance?>"><br><br>
        <label for="examfee">Examination Fee:</label>
        <input type="number" name="examfee" id="examfee" required value="<?php echo $examfee?>">
       <!-- <input type="text" readonly  value="<?php echo $approved?>">-->
       <select name="approved" id="approved" class="approved"  value="<?php echo $approved?>">
        ...
        <input type="text" name="hodname" id="hodname" required value="<?php echo $hodname?>">
        <label for="period">Date Checked:</label>
        <input type="date" name="date" id="date" required value="<?php echo $periodchecked?>">

   </fieldset><br><br>
  <!-- <fieldset class="hod">     
    <legend>Accounts Department</legend>
    <label for="feebalance">Fee Balance:</label>
    <input type="number" name="feebalance" id="feebalance" required  value="<?php echo $feebalance?>">
    <label for="examfeepaid">Exam Fee Paid:</label>
    <input type="number" name="examfeepaid" id="examfeepaid" required value="<?php echo $examfeepaid?>">
    <label for="examfeenotpaid">Exam Fee Not Paid:</label>
    <input type="number" name="examfeenotpaid" id="examfeenotpaid" required value="<?php echo $examfeenotpaid?>"><br><br>
    <label for="accountantname">Accountant Name:</label>
    <input type="text" name="accountantname" id="accountantname" required value="<?php echo $accountantname?>">
    <label for="accountsperiod">Date Checked:</label>
    <input type="date" name="accountsperiod" id="accountsperiod" required  value="<?php echo $checkedbyaccountant?>">
 </fieldset>-->
