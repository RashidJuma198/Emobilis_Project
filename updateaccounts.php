...
if(isset($_POST['update1'])){
   ...
   /*
 ,Department='".$department."',Module='".$module."',Diploma='".$diploma."'   
 ,Approved='".$approved."'
...
*/
   ...
   ,Percentage_Class_Attendance='".$percentage."' ,Examination_Fee='".$examfee."'
   ,Reason_If_Not_Approved='".$reason."',Hod_Name='".$hodname."',Period_Checked_By_Hod='".$periodchecked."',Fee_Balance='".$feebalance."' ,Exam_Fee_Paid='".$examfeepaid."',Exam_Fee_Not_Paid='".$examfeenotpaid."'
