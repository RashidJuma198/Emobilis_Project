...
$query ="SELECT *FROM tablestudent where Department ='Business Studies' AND Module='CERTIFICATE' 
AND Diploma='MOD_I' ;";
...
<div class="Title">
         <p>BUSINESS DEPARTMENT<br>STUDENT INFO</p>
    </div>
    <br><br>
   
    <nav  >
    <button><a href="student.html">NEW STUDENT</a> </button> 
      <button><a href="businessstudents.php">BUSINESS STUDENT'S </a> </button>
      <button><a href="artisanbusiness.php">ARTISAN </a></button> 
      <button><a href="mod1certbusiness.php">CERTIFICATE MOD I </a></button> 
      <button><a href="mod2certbusiness.php">CERTIFICATE MOD II</a> </button> 
      <button><a href="mod1diplomabusiness.php">DIPLOMA MOD I </a></button> 
      <button><a href="mod2diplomabusiness.php">DIPLOMA MOD II </a></button>
      <button><a href="mod3diplomabusiness.php">DIPLOMA MOD III</a> </button>
      <button><a href="businessregular.php">REGULAR</a> </button>
                    ...
                    <table >
                        ...
                        ?>
                           <tr>
                                        ...
                                        <td><a href="bussedit.php?GetID=<?php echo $userid?>">Edit</td>
