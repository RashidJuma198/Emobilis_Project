...
<body style="background-color:rgb(148, 243, 4)">
    ...
    <div class="Title">
         <p>KISIWA TECHNIAL TRAINING INSTITUTE <br>UPDATE ACCOUNT'S DETAILS</p>
    </div>
    <div class="studentname" >
        <form action="updateaccounts.php?ID=<?php echo $userid?>" method="POST" enctype="multipart/form-data">
        <fieldset>
    ...
    <fieldset class="hod">     
      ...
      <!--<Label for="mmodule">Module:</label>
        <nput type="text" name="mmodule" id="mmodule"  readonly value="<?php echo $hodmodule?>">-->
  ...
  <fieldset class="hod">     
   ...
   <fieldset class="submission">
    ...
    <button type="submit" id="submit" name="update1" style="color:black" >UPDATE</button><br>
