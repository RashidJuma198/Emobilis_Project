...
<body style="background-color:rgb(148, 243, 4)">
    ...
    <div class="Title">
         <p>DASHBOARD<br>STUDENT DETAILS</p>
    </div>
    <div class="studentname" >
        <form action="submitdashstudent.php" method="POST" enctype="multipart/form-data">
            <fieldset>
                <legend>Student Information.</legend>
            <label for="fname" class="fname" >First Name:</label>
            <input type="text" id="fname"  name="fname"  required class="ffname" >
            <label for="Mname" class="Mname" >Middle Name:</label>
            <input type="text" id="Mname"  name="mname"   required class="mmname" >
            <label for="Lname" class="Lname" >Last Name:</label>
            <input type="text" id="Lname"  name="lname"   class="llname"><br><br>
...
<fieldset class="hod">     
   ...
   <fieldset class="hod">     
    ...
    <input type="number" name="feebalance" id="feebalance" readonly>
    ...
    <input type="text" name="accountantname" id="accountantname" readonly >
...
<fieldset class="principal">     
        ...
        <input type="text" name="comments" id="comments"  readonly>
        <label for="si">Signature:</label>
        <input type="text" name="si" id="si"  readonly>
   ...
   <fieldset class="submission">
    ...
    <button style="color:black"><a href="dash1.php">EXIT</button>
   </fieldset>
</form>           
</body>
</html>
